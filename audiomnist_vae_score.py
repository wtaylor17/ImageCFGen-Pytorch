...
import torch
from deepscm_vae.audio_mnist import VAE, VALIDATION_RUNS, ATTRIBUTE_DIMS, AudioMNISTData
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        for batch in data.stream(batch_size=128,
            ...
            codes = vae.encoder.sample(img, batch)
            ...
            for _ in range(mc_rounds):
                ...
                rec = vae.decoder(codes, cf_sample)
                print(rec.shape)
